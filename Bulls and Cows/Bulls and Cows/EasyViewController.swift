...
class EasyViewController: UIViewController {
    ...
    @IBAction func easyRestartButton(_ sender: UIButton, forEvent event: UIEvent) {
        ...
        let easyRestart = UIAlertController(title: "Restart: Easy", message: "The game has been restarted.", preferredStyle: .alert)
        easyRestart.addAction(UIAlertAction(title: "Let's go!", style: .default, handler: nil))
        self.present(easyRestart, animated: true)
        AudioServicesPlayAlertSound(SystemSoundID(kSystemSoundID_Vibrate))
    }
